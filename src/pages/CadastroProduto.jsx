...
const CadastroProduto = () => {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    try {
      await axios.post(`${process.env.REACT_APP_API_URL}/api/produtos`, { 
        ...values, 
        quantidade, 
        unidade 
      });

      await axios.post(`${process.env.REACT_APP_API_URL}/api/transacoes`, {
        tipo: 'Entrada',
        data: new Date(),
        produto: values.nome,
        quantidade: quantidade,
        valor: values.valor * quantidade,
      });
      ...
      >
        {({ errors, touched }) => (
          <Form className="cadastro-form">
            ...
            {errors.valor && touched.valor && <div className="error">{errors.valor}</div>}
            ...
            <div className="quantidade-container">
              ...
              <input
                type="number"
                value={quantidade}
                onChange={(e) => setQuantidade(Math.max(1, parseInt(e.target.value) || 1))} // Garantir que o valor seja no mínimo 1
            ...
            {errors.dataEntrada && touched.dataEntrada && <div className="error">{errors.dataEntrada}</div>}
