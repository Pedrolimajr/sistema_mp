...
const EntradaProduto = () => {
  ...
  const fetchProdutos = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/produtos`);
  ...
  const handleEntrada = async () => {
    ...
    try {
      if (!selectedProduct || !produtoEncontrado) {
      ...
      await axios.post(`${process.env.REACT_APP_API_URL}/api/movimentacoes`, {
        ...
        quantidade: quantidade,
        valor: produtoEncontrado.valor * quantidade
      });

      toast.success('Entrada de produto realizada com sucesso!');
      fetchProdutos();
      setSelectedProduct('');
      ...
      toast.error('Erro ao realizar a entrada de produto. Tente novamente.');
    }
  };
...
//     try {
//       if (!selectedProduct || !quantidadeEntrada || !produtoEncontrado) {
